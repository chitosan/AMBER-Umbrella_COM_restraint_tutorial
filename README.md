...
Alternatively, you can download [this](https://drive.google.com/file/d/0B7pMJfmYx1e9SDNVZEdENTF4aWc/view?usp=sharing {:target="_blank"} "AMBER COM tutorial tgz") tarball. This has all of the same files, in addition all outputs from MD simulations are included with the exception of trajectory files (5 GB).
